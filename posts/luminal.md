...
至少截止我写这篇文章，他最新的 PR 还是 [elementwise fusion](https://github.com/luminal-ai/luminal/pull/274)。以这种程度的开发进展，显然是很难匹配他自己的宣传目标和[投资](https://techcrunch.com/2025/11/17/luminal-raises-5-3-million-to-build-a-better-gpu-code-framework/)，我怀疑挂编译器的羊头卖手动优化的狗肉。
